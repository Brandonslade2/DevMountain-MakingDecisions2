...
//// learned here from comparing to solution that I do not have to do the and operation because it checks in order anyway.
...
if (myFavoriteNumbers.length < 7) {
  ...
  sumNum = myFavoriteNumbers[6]
    ...
    console.log(`There are exactly 7 numbers in this array. The directions didn't tell me what to do if this happens so uhh... yeah... idk...I would just do just an else but that doesn't seem like what the directions want.`)
}
